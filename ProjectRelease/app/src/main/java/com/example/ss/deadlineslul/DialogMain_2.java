...
public class DialogMain_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView TextViewTop = findViewById(R.id.textView2);
        if(buffer.contains("05")){
            TextViewTop.setText("Введите кол-во кустов");
            editTextsub.setHint("Кол-во кустов");
        }
        if(buffer.contains("15")){
            TextViewTop.setText("Введите кол-во деревьев");
            editTextsub.setHint("Кол-во деревьев");
        }
        if(buffer.contains("16")){
            TextViewTop.setText("Введите кол-во деревьев");
            editTextsub.setHint("Кол-во деревьев");
        }
        if(buffer.contains("17")){
            TextViewTop.setText("Введите кол-во деревьев");
            editTextsub.setHint("Кол-во деревьев");
        }
